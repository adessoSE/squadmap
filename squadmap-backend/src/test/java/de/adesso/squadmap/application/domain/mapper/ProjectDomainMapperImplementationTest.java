...
@SpringBootTest(classes = ProjectDomainMapperImplementation.class)
@ActiveProfiles("test")
public class ProjectDomainMapperImplementationTest {

    @Autowired
    private ProjectDomainMapperImplementation projectMapper;
